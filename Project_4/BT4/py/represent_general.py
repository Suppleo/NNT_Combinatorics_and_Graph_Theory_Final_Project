            ...
            if i <= j:
                ...
                for _ in range(edge_count):
                    ...
                    if i != j: # For non-loop edges, also add reverse connections
                        ext.outgoing[j].append(edge_idx)
...
def main():
    ...
    print("=== CHƯƠNG TRÌNH CHUYỂN ĐỔI BIỂU DIỄN ĐỒ THỊ TỔNG QUÁT (CHO PHÉP ĐA BỘ VÀ KHUYÊN) ===\n")
    ...
    while i < m_input:
        try:
            ...
            # Loops are now allowed, so no check for u == v
